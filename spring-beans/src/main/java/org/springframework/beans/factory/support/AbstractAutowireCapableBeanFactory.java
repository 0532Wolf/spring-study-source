...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	 ...
	 * 忽略给定的依赖接口以进行自动连线。应用程序上下文通常使用它来注册以其他方式解析的依赖项，
	 * 例如通过 BeanFactoryAware 的 BeanFactory 或通过 ApplicationContextAaware
	 * 解析的 ApplicationContext。默认情况下，仅忽略 BeanFactoryAware 接口。
